...
export const metadata: Metadata = {
  ...
  title: {
    default: "ガタフィー | 新潟大学生のキャンパス内掲示板アプリ",
    template: "%s | ガタフィー",
  },
  description:
    "新潟大学生限定の掲示板アプリ「ガタフィー」。教科書・家具・家電・自転車などをキャンパス内で直接手渡し、学生どうしで安心してやり取りできます。新大生どうしだから安心。",
  keywords: [
    "ガタフィー",
    "新潟大学",
    "新大",
  ...
  openGraph: {
    ...
    locale: "ja_JP",
    url: SITE_URL,
    title: "ガタフィー | 新潟大学生のキャンパス内掲示板アプリ",
    description:
      "新潟大学生限定の掲示板アプリ。教科書・家具・家電などをキャンパス内で直接手渡し、安心してやり取りできます。",
    images: [
      {
        url: "/brand/campus-hero.webp",
        width: 1200,
        height: 630,
        alt: "ガタフィー — 新潟大学生のキャンパス内掲示板アプリ",
      },
    ],
  },
  twitter: {
    ...
    title: "ガタフィー | 新潟大学生のキャンパス内掲示板アプリ",
    description:
      "新潟大学生限定の掲示板アプリ。教科書・家具・家電などをキャンパス内で安心してやり取り。",
    ...
    "@graph": [
      {
        ...
        name: "ガタフィー",
        description:
          "新潟大学生限定の掲示板アプリ。キャンパス内で安心して譲渡・売買のやり取りができます。",
        inLanguage: "ja",
      },
      {
        "@type": "Organization",
